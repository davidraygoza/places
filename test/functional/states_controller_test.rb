...
class StatesControllerTest < ActionController::TestCase
  ...
  test "should create state" do
    assert_difference('State.count') do
      post :create, state: { description: @state.description, latitude: @state.latitude, longitude: @state.longitude }
    end
  ...
  test "should update state" do
    put :update, id: @state, state: { description: @state.description, latitude: @state.latitude, longitude: @state.longitude }
    assert_redirected_to state_path(assigns(:state))
  end
